...
\usepackage{fontspec}	% for loading Fontin fonts
\usepackage{fontawesome}	% Symbols for Email, Github.
\usepackage{hyperref}	% for hyperlinks
\usepackage[usenames,dvipsnames]{xcolor}	% Color package
\usepackage[big]{layaureo}	% wider formatting of the A4 page
\usepackage{titlesec}	% custom \section
\usepackage{fancyhdr}	% Headers and footers
\usepackage[absolute]{textpos}	% Alignment of page
\usepackage{graphicx}	% For image loading
\usepackage{caption}	% Caption setup for image
\usepackage{float}	% Minipage settings for side by side
...
\titlespacing{\section}{0pt}{15pt}{3pt} % Spacing between Sections of two sections. Increase 2nd field to add more space between 2 sections.
